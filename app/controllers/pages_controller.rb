class PagesController < ApplicationController
  ...
  def top
    ...
    #@rankings = Bravo.left_joins(:post).where(created_at: Date.current.in_time_zone.all_day).sort {|a, b| (b.post.bravo_users.count <=> a.post.bravo_users.count).nonzero? || (b.post.impressions_count <=> a.post.impressions_count)}.take(10)
